...
//used 1 based indexing on tree adn 0 based for array
class SegmentTree{
    int n;
    ...
    public:
        ...
        void build(const vector<int>&arr,int node,int l,int r){
            ...
            if(l==r) tree[node]=arr[l];
                ...
                //this is where operations happen(currently i am adding both the nodes)
            }
        ...
        long long query(int node,int l,int r,int ql,int qr){
            ...
            if(qr<l || r<ql) return LLONG_MAX; //no overlap(think what to return if same)
